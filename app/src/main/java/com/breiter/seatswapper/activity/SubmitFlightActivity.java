...
public class SubmitFlightActivity extends AppCompatActivity implements View.OnClickListener {
    ...
    private void makeAirportsAutocomplete() {
        ...
        ArrayAdapter<String> adapterCities = new ArrayAdapter<>(this, android.R.layout.simple_list_item_1, airports);
    ...
    private void makeAirlinesAutocomplete() {
        ...
        ArrayAdapter<String> adapter = new ArrayAdapter<>(this, android.R.layout.simple_list_item_1, airlines);
        ...
        rootRef.child("Flights").child(flightId).setValue(flightMap).addOnCompleteListener(new OnCompleteListener<Void>() {
            ...
            public void onComplete(@NonNull Task<Void> task) {
                if (task.isSuccessful()) {
                    ...
                    Toast.makeText(SubmitFlightActivity.this, "Your flight couldn't be submitted. Try again...", Toast.LENGTH_SHORT).show();
    ...
    public void dismissKeyboard() {
        ...
        if (SubmitFlightActivity.this.getCurrentFocus() != null && inputMethodManager != null)
